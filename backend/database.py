...
_OR_REPLACE_TARGETS = {"fyndnot_ml_annotations": ["project_id", "row_index"]}
...
def _migrate(db):
    ...
    if DATABASE_TYPE == "sqlite":
        ...
        existing = {
            ...
            for r in db.execute(
                ...
                "WHERE table_name='fyndnot_projects'"
            ).fetchall()
        }
    ...
    for col, coltype in [
        ...
        if col not in existing:
            db.execute(f"ALTER TABLE fyndnot_projects ADD COLUMN {col} {coltype}")
